...
public class FileSearchStatusReporter implements IStatusReporter
{
	...
	@Override public void reportSuccess(AbstractSuccessMessage message)
	{
	...
	@Override public void reportStatus(AbstractStatusMessage message)
	{
	...
	@Override public void reportCompletion()
	{
		((SearchResultInternalFrame)_parent).updateUIForThreadCompletion();
	}
	
	@Override public void reportCancellation()
	{
